 ...
 * @param e Puntero al evento LVGL que dispara el envío del comando.
 *
 * @note Es importante que la respuesta cumpla con el formato esperado por el POS.
 */
static void send_init_response(lv_event_t *e) {
 ...
 *       tales como actualizaciones OTA, manejo avanzado de eventos, integración de sensores adicionales,
 *       o mejoras en la interfaz gráfica.
 */
void app_main(void)
{

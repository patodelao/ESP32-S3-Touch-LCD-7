...
void register_lcd_event_callbacks(esp_lcd_panel_handle_t panel_handle, lv_disp_drv_t *disp_drv)
{
    ...
    esp_lcd_rgb_panel_event_callbacks_t cbs = {
        .on_vsync = example_on_vsync_event, // Callback para evento VSYNC
    };
...
// Función para instalar el temporizador LVGL
void install_lvgl_tick_timer(void)
{
    ESP_LOGI(TAG, "Install LVGL tick timer");
    
    // Definición de los argumentos para el temporizador LVGL
    ...
    // Iniciar el temporizador de manera periódica
